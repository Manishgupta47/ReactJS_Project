    ...
    <div classNameName="container">
      <div classNameName="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" classNameName="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
          <svg classNameName="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap"><use xlink:Href="#bootstrap"></use></svg>
        </a>
        ...
        <htmlform classNameName="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
          <input type="search" classNameName="htmlform-control htmlform-control-dark text-bg-dark" placeholder="Search..." aria-label="Search"/>
        </htmlform>
